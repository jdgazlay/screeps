...
module.exports.loop = function () {
    ...
    var HARVESTER_BODY = [MOVE, WORK, CARRY];
    var BUILDER_BODY = [WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE];
    var UPGRADER_BODY = [WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE];
